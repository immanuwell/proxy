...
const file_cilium_api_npds_proto_rawDesc = "" +
	...
	"\x14cilium.NetworkPolicy2\xde\x02\n" +
...
var file_cilium_api_npds_proto_goTypes = []any{
	...
	(*v33.DeltaDiscoveryRequest)(nil),  // 20: envoy.service.discovery.v3.DeltaDiscoveryRequest
	(*v33.DiscoveryRequest)(nil),       // 21: envoy.service.discovery.v3.DiscoveryRequest
	(*v33.DeltaDiscoveryResponse)(nil), // 22: envoy.service.discovery.v3.DeltaDiscoveryResponse
	(*v33.DiscoveryResponse)(nil),      // 23: envoy.service.discovery.v3.DiscoveryResponse
}
var file_cilium_api_npds_proto_depIdxs = []int32{
	...
	20, // 22: cilium.NetworkPolicyDiscoveryService.DeltaNetworkPolicies:input_type -> envoy.service.discovery.v3.DeltaDiscoveryRequest
	21, // 23: cilium.NetworkPolicyDiscoveryService.StreamNetworkPolicies:input_type -> envoy.service.discovery.v3.DiscoveryRequest
	21, // 24: cilium.NetworkPolicyDiscoveryService.FetchNetworkPolicies:input_type -> envoy.service.discovery.v3.DiscoveryRequest
	21, // 25: cilium.NetworkPolicyResourceDiscoveryService.StreamNetworkPolicyResources:input_type -> envoy.service.discovery.v3.DiscoveryRequest
	20, // 26: cilium.NetworkPolicyResourceDiscoveryService.DeltaNetworkPolicyResources:input_type -> envoy.service.discovery.v3.DeltaDiscoveryRequest
	22, // 27: cilium.NetworkPolicyDiscoveryService.DeltaNetworkPolicies:output_type -> envoy.service.discovery.v3.DeltaDiscoveryResponse
	23, // 28: cilium.NetworkPolicyDiscoveryService.StreamNetworkPolicies:output_type -> envoy.service.discovery.v3.DiscoveryResponse
	23, // 29: cilium.NetworkPolicyDiscoveryService.FetchNetworkPolicies:output_type -> envoy.service.discovery.v3.DiscoveryResponse
	23, // 30: cilium.NetworkPolicyResourceDiscoveryService.StreamNetworkPolicyResources:output_type -> envoy.service.discovery.v3.DiscoveryResponse
	22, // 31: cilium.NetworkPolicyResourceDiscoveryService.DeltaNetworkPolicyResources:output_type -> envoy.service.discovery.v3.DeltaDiscoveryResponse
